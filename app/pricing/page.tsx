...
import { CheckCircle, ArrowRight, ChevronDown, Shield, Lock, CreditCard, Check, Leaf, Menu, X, Twitter, Linkedin, Github, Mail } from "lucide-react";
...
export default function PricingPage() {
  ...
  const scrollToSection = (sectionId: string) => {
    if (sectionId === 'features-section' || sectionId === 'pricing-section') {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF9] dark:bg-gray-900">
      {/* Header */}
      <header className="sticky top-0 z-50 bg-white/95 dark:bg-gray-900/95 backdrop-blur-lg shadow-sm border-b border-gray-200 dark:border-gray-800">
